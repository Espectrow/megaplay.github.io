...
var flap = loadGameSound('https://espectrow.000webhostapp.com/style/sound/flap.wav', 3);

var coin = loadGameSound('https://espectrow.000webhostapp.com/style/sound/coin.wav', 1);

var punch = loadGameSound('https://espectrow.000webhostapp.com/style/sound/punch.wav', 1);
...
var tile_colors = ['2', '4', '8', '16', '32', '64', '128', '256', '512', '1024', '2048'];
var tile_colors_2 = ['2', '4', '8', '16', '32', '64', '128', '256', '512', '1024', '2048'];
...
function newCell () {
 ...
 div.style.border = '12px solid #d84315';
 div.style.borderRadius = '8px';
 div.style.zIndex = 311;
 div.className = 'cellol';
 div.unselectable = 'on';
 div.style.backgroundImage = cell.background = '#' +tile_colors[0];
 ...
 cell.setValue = function (n) {
  ...
  if (n == 0) {
   ...
   if (tci >= tile_colors.length) {
	...
	if(ban==0){	   
   		div.style.backgroundImage = cell.background = 'url("dbz1/' +c+ '.png")';
   		div.style.backgroundSize = cell.background = 'cover';
	}else{
   		div.style.backgroundImage = cell.background = 'url("dbz1/' +c+ '.png")';
   		div.style.backgroundSize = cell.background = 'cover';
